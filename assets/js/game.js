...
//console.log("Name = " + playerInfo.name, "| Attack Power = " + playerInfo.attack, "| Health = " + playerInfo.health, "| Money = $" + playerInfo.money);
...
var fight = function(enemy) {
  ...
  console.clear();
  console.log("Player Name = " + playerInfo.name, "| Attack Power = " + playerInfo.attack, "| Health = " + playerInfo.health, "| Money = $" + playerInfo.money);
  console.log("Enemy Name = " + enemy.name, "| Attack Power = " + enemy.attack, "| Health = " + enemy.health);
...
var shop = function(){
  ...
  var shopOptionPrompt = window.prompt("Would you like to (1) REFILL your health, (2) UPGRADE your attack, or (3) LEAVE the store?")
  shopOptionPrompt = parseInt(shopOptionPrompt); //convert string to int for use in switch case
